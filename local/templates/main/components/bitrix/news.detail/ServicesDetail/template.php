...
<?php if (!empty($arResult['ID'])): ?>
    ...
    <section class="who-area-are pad-90" id="about_us">
        <div class="container">
            ...
            <div class="row">
                <?php if (!empty($arResult['detail_description']['VALUE']['TEXT'])): ?>
                    <div class="col-md-7">
                        <div class="who-we">
                            <?= $arResult['detail_description']['VALUE']['TEXT']; ?>
                        </div>
                    </div>
                <?php endif; ?>

                <?php if (!empty($arResult['detail_image']['SRC'])): ?>
                    <div class="col-md-5">
                        <div class="about-bg">
                            <img src="<?= $arResult['detail_image']['SRC']; ?>" alt="<?= $arResult['detail_image']['ALT'] ?>" />
                        </div>
                    </div>
                <?php endif; ?>
    ...
    <div class="pb-60">
        <div class="container">
            <div class="row">
                <?php if (!empty($arResult['PROPERTIES']['q_a']['VALUE'])): ?>
                    <div class="col-md-6">
                        <h3 class="mb-30">
                        ...
                        <div class="brand-accordion">
                            <div class="panel-group icon angle-icon" id="accordion" role="tablist" aria-multiselectable="true">
                                <?php $ind = 0; ?>
                                <?php foreach ($arResult['PROPERTIES']['q_a']['VALUE'] as $faqInd => $faqVal): ?>
                                    <div class="panel panel-default">
                                        <?php if ($arResult['PROPERTIES']['q_a']['DESCRIPTION'][$faqInd]): ?>
                                                ...
                                                <h4 class="panel-title">
                                                    <a class="<?= ($ind === 0) ? '': 'collapsed'; ?>"
                                                       ...
                                                       data-toggle="collapse" data-parent="#accordion" href="#collapse<?= $faqInd; ?>" aria-expanded="true" aria-controls="collapseOne">
                                                        <?= $arResult['PROPERTIES']['q_a']['DESCRIPTION'][$faqInd]; ?>
                                                    </a>
                                                </h4>
                                            </div>
                                        <?php endif; ?>
